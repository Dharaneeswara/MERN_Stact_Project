...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
        {/* <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] bg-gray-50 sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'> */}
        <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border border-gray-100 rounded-xl text-[#5E5E5E] text-sm shadow-lg bg-white'>
