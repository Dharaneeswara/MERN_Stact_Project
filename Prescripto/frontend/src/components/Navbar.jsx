...
const Navbar = () => {
    ...
    // const [token, setToken] = useState(true) //it is for temporary usage
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <div className='flex item-center gap-4'>
            ...
            <div className={`${showMenu ? 'fixed w-full':'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white trasition-all duration-100`}>
